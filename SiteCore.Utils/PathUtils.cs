...
namespace SiteCore.Utils
{
    public static class PathUtils
    {
        ...
        {
            return Combine(SiteCoreAssets.GetPath("menus"), Combine(paths));
        }

        public static string PhysicalSiteCorePath => Combine(WebConfigUtils.PhysicalApplicationPath, WebConfigUtils.AdminDirectory);
