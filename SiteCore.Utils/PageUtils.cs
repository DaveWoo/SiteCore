...
using System.Web;
using SiteCore.Utils.Enumerations;
using SiteCore.Utils.Enumerations;
...
namespace SiteCore.Utils
{
    public static class PageUtils
    {
        ...
        public static string SessionId
        {
            get
            {
                var sessionId = CookieUtils.GetCookie("SiteCore.SessionID");
                ...
                CookieUtils.SetCookie("SiteCore.SessionID", sessionId, DateTime.Now.AddDays(100));
                return sessionId;
            }
        }
        ...
        public static string GetSiteCoreUrl(string className)
        {
            return GetAdminUrl(className.ToCamelCase() + ".cshtml");
        }

        public static string GetSiteCoreUrl(string className, NameValueCollection queryString)
        {
