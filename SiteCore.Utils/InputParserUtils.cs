...
namespace SiteCore.Utils
{
    public class InputParserUtils
    {
        ...
        public static void GetValidateAttributesForListItem(ListControl control, bool isValidate, string displayName, bool isRequire, int minNum, int maxNum,  string regExp, string errorMessage)
        {
